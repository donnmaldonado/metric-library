-- Distinct students with at least one out-of-school suspension / active enrollment, per school year.
with disciplined as (
    select
        school_year,
        school_id,
